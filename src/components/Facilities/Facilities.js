...
import cafeimg from "../images/cafeteria.png"
import base from"../images/basketball.png"
...
const Facilities = () => {
    return (
        <section className="facilities">
            ...
            <p>
                Immerse yourself in a world of exceptional amenities and services
            </p>
            <div className="row">
                ...
                <div className="facilities-col">
                    <img src={base}alt="basketball court" />
